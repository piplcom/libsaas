...
from . import companies, contacts


class HubSpot(base.Resource):
    """
    """
    ...
    def __init__(self, api_token):
        ...
        """
        self.apiroot = "https://api.hubapi.com"
    ...
    # @base.resource(activities.AnalyticsType)
    ...
    #     :vartype type_id: str
    #     """
    #     return activities.AnalyticsType(self, type_id)
    #
    # @base.resource(activities.AnalyticsTypes)
    # def activity_types(self):
    #     """
    #     Return the resource corresponding to all activity types
    #     """
    #     return activities.AnalyticsTypes(self)
    #
    ...
    #
    # @base.resource(activities.Analytics)
    # def activities(self):
    #     """
    #     Return the resource corresponding to all activities
    #     """
    #     return activities.Analytics(self)
    #
    ...
    @base.resource(companies.CompaniesDomain)
    def companies_domain(self, domain):
        """
        Return the resource corresponding to all organizations
        """
        return companies.CompaniesDomain(self, domain)
    ...
    #                     return_field_key=None, return_item_ids=1, start=None, limit=None):
    #     """
    #     Preform a search
    #     """
    #     params = base.get_params(None, locals())
